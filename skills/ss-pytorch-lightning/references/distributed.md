...
export WORLD_SIZE=16  # 2 nodes x 8 GPUs
export NODE_RANK=0
...
**Benefits**: 2x faster than BF16 on H100
...
# Effective batch = batch_size x accumulate_grad_batches x num_gpus
# Example: 32 x 4 x 8 = 1024
```
